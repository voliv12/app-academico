...
Class Departamento extends CI_controller{
    ...
    {                                   
        ...
        //*******CLINICA
        $art_nac_cl = $this->publicaciones_model->articulos_departamento('Clínica',$fecha_de, $fecha_hasta, "Nacional");
        $art_int_cl = $this->publicaciones_model->articulos_departamento('Clínica',$fecha_de, $fecha_hasta, "Internacional");
        $lib_nac_cl = $this->publicaciones_model->libros_departamento('Clínica',$fecha_de, $fecha_hasta, "Nacional");
        $lib_int_cl = $this->publicaciones_model->libros_departamento('Clínica',$fecha_de, $fecha_hasta, "Internacional");
        $cap_nac_cl = $this->publicaciones_model->capitulos_departamento('Clínica',$fecha_de, $fecha_hasta, "Nacional");
        $cap_int_cl = $this->publicaciones_model->capitulos_departamento('Clínica',$fecha_de, $fecha_hasta, "Internacional");
        //*******SISTEMAS DE SALUD
